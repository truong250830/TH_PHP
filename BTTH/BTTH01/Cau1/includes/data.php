...
$flowers = [
        [
            ...
            "images" => ["images/hoa1.webp", "images/dayenthao.webp"],
        ],
        [
            "name" => "Hoa Đồng Tiền",
            ...
            "images" => ["images/hoadongtien.webp", "images/dongtien2.webp"],
        ],
        [
            "name" => "Hoa Giấy",
            ...
            "images" => ["images/hoagiay.webp", "images/hoagiay2.webp"],
        ],
        [
            "name" => "Hoa Thanh Tú",
            ...
            "images" => ["images/hoathanhtu.webp", "images/hoathanhtu2.webp"],
        ],
        [
            "name" => "Hoa Đèn Lồng",
            ...
            "images" => ["images/hoadenlong.webp", "images/hoadenlong2.webp"],
        ],
        [
            "name" => "Hoa Cẩm Chướng",
            ...
            "images" => ["images/camchuong.webp", "images/camchuong2.webp"],
        ],
        [
            "name" => "Hoa Huỳnh Anh",
            ...
            "images" => ["images/hoaquynhanh.jpg", "images/hoaquynhanh2.webp"],
        ],
        [
            "name" => "Hoa Păng-xê",
            ...
            "images" => ["images/hoapangxe.webp", "images/hoapangxe2.webp"],
        ],
        [
            "name" => "Hoa Sen",
            ...
            "images" => ["images/sen.webp", "images/sen2.webp"],
        ],
        [
            "name" => "Hoa Dừa Cạn",
            ...
            "images" => ["images/duacan.webp", "images/duacan2.webp"],
        ],
        [
            "name" => "Hoa Sử Quân Tử",
            ...
            "images" => ["images/hoasu.webp", "images/hoasu2.webp"],
        ],
        [
            "name" => "Hoa Cúc Lá Nho",
            ...
            "images" => ["images/cuclanho.webp", "images/cuclanho2.webp"],
        ],
        [
            "name" => "Cẩm Tú Cầu",
            ...
            "images" => ["images/camtucau.webp", "images/camtucau2.webp"],
        ],
        [
            "name" => "Hoa Cúc Dại",
            ...
            "images" => ["images/cucdai.webp", "images/cucdai2.webp"],
        ]
    ];
